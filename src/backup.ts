...
function backupsDir(claudeDir: string): string {
  return join(claudeDir, "teleport-backups");
}

export async function createBackup(claudeDir: string): Promise<BackupManifest> {
...
export function cleanOldBackups(keep: number, claudeDir: string): string[] {
