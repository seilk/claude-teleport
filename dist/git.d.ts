...
export declare function publicRepoExists(username: string): {
    exists: boolean;
    repoUrl?: string;
};
export declare function cloneOrPullPublic(username: string, localPath: string): void;
export declare function readMachineFromPublic(repoPath: string, alias: string): Snapshot | null;
export declare function pushToPublicRepo(repoPath: string, machineAlias: string, snapshot: Snapshot, username?: string): PushResult;
